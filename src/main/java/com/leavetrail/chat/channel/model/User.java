...
public class User {
    ...
    @Column("personal_group_id")
    private UUID personalGroupId;
    
    @CassandraType(type = CassandraType.Name.LIST, typeArguments = {CassandraType.Name.UDT}, userTypeName = "group")
    private List<GroupType> memberOf;
