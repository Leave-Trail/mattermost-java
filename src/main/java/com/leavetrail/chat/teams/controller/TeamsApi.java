...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2023-05-20T18:55:45.547352+02:00[Europe/Warsaw]")
@Validated
...
public interface TeamsApi {
    ...
    default ResponseEntity<TeamMember> addTeamMemberFromInvite(
    ...
    default ResponseEntity<Void> getTeamIcon(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<GetTeamInviteInfo200Response> getTeamInviteInfo(
    ...
    default ResponseEntity<TeamMember> getTeamMember(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
    ...
    default ResponseEntity<List<TeamMember>> getTeamMembersByIds(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
    ...
    default ResponseEntity<List<TeamMember>> getTeamMembersForUser(
        @Parameter(name = "user_id", description = "User GUID", required = true, in = ParameterIn.PATH) @PathVariable("user_id") String userId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<TeamStats> getTeamStats(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<TeamUnread> getTeamUnread(
        @Parameter(name = "user_id", description = "User GUID", required = true, in = ParameterIn.PATH) @PathVariable("user_id") String userId,
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId
    ) {
        getRequest().ifPresent(request -> {
    ...
    default ResponseEntity<List<TeamUnread>> getTeamsUnreadForUser(
        @Parameter(name = "user_id", description = "User GUID", required = true, in = ParameterIn.PATH) @PathVariable("user_id") String userId,
    ...
    default ResponseEntity<ImportTeam200Response> importTeam(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
    ...
    default ResponseEntity<StatusOK> invalidateEmailInvites(
    ...
    default ResponseEntity<StatusOK> inviteGuestsToTeam(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
    ...
    default ResponseEntity<StatusOK> inviteUsersToTeam(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
    ...
    default ResponseEntity<Team> patchTeam(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
    ...
    default ResponseEntity<Team> regenerateTeamInviteId(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<StatusOK> removeTeamIcon(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<StatusOK> removeTeamMember(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
        @Parameter(name = "user_id", description = "User GUID", required = true, in = ParameterIn.PATH) @PathVariable("user_id") String userId
    ) {
        getRequest().ifPresent(request -> {
    ...
    default ResponseEntity<Team> restoreTeam(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<StatusOK> setTeamIcon(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
     ...
     *
     * @param teamId Team GUID (required)
     * @param permanent Permanently delete the team, to be used for compliance reasons only. As of server version 5.0, &#x60;ServiceSettings.EnableAPITeamDeletion&#x60; must be set to &#x60;true&#x60; in the server&#39;s configuration. (optional, default to false)
    ...
    default ResponseEntity<StatusOK> softDeleteTeam(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
    ...
    default ResponseEntity<TeamExists> teamExists(
        @Parameter(name = "name", description = "Team Name", required = true, in = ParameterIn.PATH) @PathVariable("name") String name
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<Void> teamMembersMinusGroupMembers(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
    ...
    default ResponseEntity<StatusOK> updateTeamMemberRoles(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
        @Parameter(name = "user_id", description = "User GUID", required = true, in = ParameterIn.PATH) @PathVariable("user_id") String userId,
    ...
    default ResponseEntity<StatusOK> updateTeamMemberSchemeRoles(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
        @Parameter(name = "user_id", description = "User GUID", required = true, in = ParameterIn.PATH) @PathVariable("user_id") String userId,
    ...
    default ResponseEntity<Team> updateTeamPrivacy(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
    ...
    default ResponseEntity<StatusOK> updateTeamScheme(
        @Parameter(name = "team_id", description = "Team GUID", required = true, in = ParameterIn.PATH) @PathVariable("team_id") String teamId,
